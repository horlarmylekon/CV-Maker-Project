...
import com.intellisense.cvmaker.service.EmailService;
import com.intellisense.cvmaker.service.UserService;
...
public class MainController {
    ...
    public ModelAndView processRegistrationForm(ModelAndView modelAndView, @Valid User user, BindingResult bindingResult, HttpServletRequest httpRequest) {
       ...
       if (bindingResult.hasErrors()){
           ...
           //new user will be created and send confirmation e-mail

           //disable user until they click on the confirmation link in email
